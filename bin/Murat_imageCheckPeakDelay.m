...
pd_analysis                 =   figure('Name',pd_title,...
    'NumberTitle','off','Position',[16,400,1200,1000],'visible','off');

log10Time                   =   log10(time0PD);
fitrobust_i                 =...
    fitrobust_k(1)*log10Time + fitrobust_k(2);

plot(log10Time,log10(peakData_k),'ko', 'MarkerSize',4,'MarkerEdgeColor',[0 0 0], 'MarkerFaceColor', [0.5 0.5 0.5])
hold on
plot(log10Time,fitrobust_i,'r-','LineWidth',4)
